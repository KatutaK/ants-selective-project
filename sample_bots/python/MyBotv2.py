...
class MyBot:
    ...
    def do_turn(self, ants):
        ...
        for a_row, a_col in ants.my_ants():
            ...
            target_destination = self.nearest_food_sources(coord,ants)
            ...
            #print >> open('MyBotv1_log.txt', 'a'), 'origin',coord,'target',target_destination, 'directions',location_directions
